...
class Patient
{
    private: // Private access specifier (data security) 
        ...
        float billAmount; // Stores bill amount
    ...
    {
        patientId = id; // Set patient ID
        patientName = name; // Set patient name
        billAmount = bill; // Set bill amount
        appointmentDate = date; // Set appointment date
    }
    ...
    void display()
    {
        ...
        cout << "\nBill Amount :" << billAmount; //Displays billing amount
